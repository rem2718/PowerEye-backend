...
def test_validate_room_name_valid_name(setup_teardown_mongo_connection):
...
def test_validate_room_name_user_not_found(setup_teardown_mongo_connection):
...
def test_validate_room_name_invalid_name_type(setup_teardown_mongo_connection):
...
def test_validate_room_name_invalid_name_length(setup_teardown_mongo_connection):
...
def test_validate_room_name_duplicate_name(setup_teardown_mongo_connection):
    # Create a test user
    user = User()
...
def test_create_room_success(setup_teardown_mongo_connection):
...
def test_create_room_user_not_found(setup_teardown_mongo_connection):
...
def test_create_room_no_appliances_provided(setup_teardown_mongo_connection):
...
def test_create_room_invalid_room_name(setup_teardown_mongo_connection):
...
def test_create_room_appliance_not_found(setup_teardown_mongo_connection):
...
def test_create_room_appliance_deleted(setup_teardown_mongo_connection):
...
def test_get_room_appliances_success(setup_teardown_mongo_connection):
...
def test_get_room_appliances_user_not_found(setup_teardown_mongo_connection):
...
def test_get_room_appliances_room_not_found(setup_teardown_mongo_connection):
...
def test_add_appliances_to_room_appliances_added_successfully(setup_teardown_mongo_connection):
    response, status_code = add_appliances_to_room('64d154bc94895e0b4c1bc080', '65734345413329dd0d56e2b7', ['64d1687493d44252699aa22c'])
    assert status_code == 200

def test_add_appliances_to_room_user_not_found(setup_teardown_mongo_connection):
    response, status_code = add_appliances_to_room('65678dba8535b0176edcda69', '65734345413329dd0d56e2b7', ['64d1659d93d44252699aa225'])
    assert status_code == 500

def test_add_appliances_to_room_room_not_found(setup_teardown_mongo_connection):
    response, status_code = add_appliances_to_room('64d154bc94895e0b4c1bc080', '656d30f357fbb78f4d61e873', ['64d1659d93d44252699aa225'])
    assert status_code == 404

def test_add_appliances_to_room_invalid_appliance_ids_not_list(setup_teardown_mongo_connection):
    response, status_code = add_appliances_to_room('64d154bc94895e0b4c1bc080', '65734345413329dd0d56e2b7', '64d1659d93d44252699aa225')
    assert status_code == 400

def test_add_appliances_to_room_appliance_not_found(setup_teardown_mongo_connection):
    response, status_code = add_appliances_to_room('64d154bc94895e0b4c1bc080', '65734345413329dd0d56e2b7', ['64d1629393d44252699aa21b'])
    assert status_code == 400

def test_add_appliances_to_room_appliance_marked_deleted(setup_teardown_mongo_connection):
    response, status_code = add_appliances_to_room('64d154bc94895e0b4c1bc080', '65734345413329dd0d56e2b7', ['64d1659d93d44252699aa225'])
    assert status_code == 400

def test_add_appliances_to_room_appliances_already_in_room(setup_teardown_mongo_connection):
...
def test_get_all_user_rooms_success(setup_teardown_mongo_connection):
    response, status_code = get_all_user_rooms('64d154bc94895e0b4c1bc080')
    assert status_code == 200

def test_get_all_user_rooms_user_not_found(setup_teardown_mongo_connection):
    response, status_code = get_all_user_rooms('65678dba8535b0176edcda69')
    assert status_code == 500

def test_get_all_user_rooms_no_rooms_found(setup_teardown_mongo_connection):
    response, status_code = get_all_user_rooms('64d154d494895e0b4c1bc081') #qatar
    print(response.get_data(as_text=True))
    print(status_code)
    assert status_code == 404

def test_get_all_user_rooms_appliance_not_found(setup_teardown_mongo_connection):
    response, status_code = get_all_user_rooms('656ef0fe08a5e799018f9771')
    assert status_code == 500

# ---------------------------------------Delete Appliance From Room Test-----------------------------------------------------------
def test_delete_appliance_from_room_success(setup_teardown_mongo_connection):
...
def test_delete_appliance_from_room_user_not_found(setup_teardown_mongo_connection):
...
def test_delete_appliance_from_room_room_not_found(setup_teardown_mongo_connection):
...
def test_delete_appliance_from_room_appliance_not_found(setup_teardown_mongo_connection):
