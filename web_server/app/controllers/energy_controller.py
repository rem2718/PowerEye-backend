...
def get_appliance_daily_energy(time_since_current):
    return
def get_appliance_weekly_energy(time_since_current):
    return
def get_appliance_monthly_energy(time_since_current):
    return
def get_appliance_yearly_energy(time_since_current):
    return
